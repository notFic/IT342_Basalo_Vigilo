...
interface VisitorApi {
    ...
    fun checkOutVisitor(@Path("logId") logId: Long, @Query("updatedByEmail") updatedByEmail: String): Call<VisitorRecord>

    @PUT("logs/{logId}/void")
    fun voidVisitorLog(@Path("logId") logId: Long, @Query("updatedByEmail") updatedByEmail: String): Call<VisitorRecord>
}
